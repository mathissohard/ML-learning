    ...
    def train(self):
        ...
        for step in range(self.net_config.num_iterations+1):
            ...
            if step == self.net_config.num_iterations:
                ...
                x, _, _ = self.model_actor.propagate(num_sample, x0, dw_sample, z, training=False,
                                                     T=self.eqn_config.total_time_actor, N=self.eqn_config.num_time_interval_actor, cheat=False)
                print("state x:", x)
